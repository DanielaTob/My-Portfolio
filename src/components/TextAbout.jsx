...
export default function TextAbout() {
  return (
    <div>
    <h1 className="font-paragraph text-colortitle font-bold pl-9 lg:pt-8 md:pt-8 pt-8 sm:pt-16 text-3xl animate__animated animate__fadeInLeft">A Little Bit About Me</h1>
