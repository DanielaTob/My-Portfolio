...
export default function TextAbout() {
  return (
    ...
    <div className='text-center mx-4 leading-8 font-title sm:text-base md:text-lg lg:text-xl xl:text-xl 2xl:text-xl text-colorparagraph pt-10 px-10'>
        ...
        <p className='pb-2 text-justify inline-block'>I am a Software developer with experience in projects with a focus on responsive design and accessibility, especially with scrum methodology. Creative expression is what lights me up, and I'm always open to learning about new opportunities. </p> 
