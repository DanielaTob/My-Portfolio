...
const MenuItems = ({showMenu, active}) => {
  return (
        ...
        <ul className={active ? 'flex-col flex items-center fixed inset-0 left-1/4 bg-black/40 backdrop-blur-lg gap-8 justify-center p-8 md:hidden z-10' : 'hidden'}>
                ...
                <Link to="Skills"><li className='font-fontFamily-paragraph text-bglight transition ease-in-out delay-150  hover:-translate-y-1 hover:scale-110 hover:text-red'>Skills</li></Link> 
                <Link to="About"><li className='font-fontFamily-paragraph text-bglight transition ease-in-out delay-150  hover:-translate-y-1 hover:scale-110 hover:text-red'>About</li></Link> 
